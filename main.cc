...
int main() {
	...
	TYPER("Welcome to StarKek!"); NarrP();
	elipse();
	TYPER("It's approximately 0600 hours\nStar Date: 46436.3014"); NarrP();
	TYPER("The pinnacle of coffee scents fills your nostrils as you sit on the rooftop balcony of the");
	TYPER("best coffee shop in the Federation."); NarrP();
	TYPER("It sits just on the outskirts of New York City."); NarrP();
	TYPER("Based on the weather patterns in the sky, you sense that this will be one of the most ");
	TYPER("beautiful sunrises over the city that you've ever seen.\n"); elipse();
	while (true) {
		elipse(); cout << endl;
		TYPER("Someone is hailing you on your communicator.\a"); NarrP();
	...
	TYPER("GENERAL: "); NarrP(); TYPER("Captain, the Federation is in dire need of your assistance."); NarrP();
	TYPER("We need you to deliver a valuable care-package on a top secret mission to Andromeda."); NarrP();
	TYPER("We have already assembled a crew and readied a new space craft");
	TYPER("that has just finished contruction."); NarrP();
	elipse();
	TYPER("Will you accept the mission?");
	getline(cin, action);
	TYPER("GENERAL: "); NarrP(); TYPER("Thank you! I knew you would do it!"); NarrP();
	TYPER("Head to terminal 96 at the space port."); // Perhaps instead of password, the general tells you the terminal number is some number riddle and you have to find it by entering the correct answer where the password prompt currently is.
